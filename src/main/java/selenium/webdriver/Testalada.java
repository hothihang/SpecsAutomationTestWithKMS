...
public class Testalada {
	...
	//Geckodriver là một là một liên kết trung gian giữa Selenium test của chúng ta và trình duyệt Firefox. 
	//Nó là một proxy mà các client sử dụng W3C- Webdriver tương thích và sẽ thông qua đó để tương tác với các trình duyệt nhờ Gecko. 
	//Geckodriver cung cấp HTTP API để giao tiếp với các gecko browser và ở đây là trình duyệt Firefox ver 48.

	//@BeforeClass: Phương thức chú thích @BeforeClass chạy trước khi thực thi các phương thức kiểm tra trong một lớp hiện tại.
